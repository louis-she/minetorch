...
class MatplotlibDrawer(Drawer):
    ...
    def __init__(self):
        super().__init__()
        self.graph_dir = os.path.join(self.code_dir, 'graphs')
    ...
    def save_png(self, graph):
        ...
        self.fire("drawer.image_saved", path=png_file, graph=graph)
        return png_file
