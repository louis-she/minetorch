import minetorch.proto.minetorch_pb2 as minetorch_pb2
...
TIMER_ITERATION = minetorch_pb2.TimerCategory.Value('ITERATION')
TIMER_EPOCH = minetorch_pb2.TimerCategory.Value('EPOCH')
TIMER_SNAPSHOT = minetorch_pb2.TimerCategory.Value('SNAPSHOT')
