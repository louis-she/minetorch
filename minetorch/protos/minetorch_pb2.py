...
# source: minetorch/minetorch/protos/minetorch.proto
...
HeyMessage = _reflection.GeneratedProtocolMessageType('HeyMessage', (_message.Message,), dict(
  ...
  __module__ = 'minetorch.minetorch.protos.minetorch_pb2'
